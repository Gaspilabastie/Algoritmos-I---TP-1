    ...
    {}
        \requiere{
            ...
            (\forall i : \ent) (0 \leq i <|{\textit{trayectorias}}\vert \implicaLuego (
                |{\textit{trayectorias}[i]}\vert =  1 \y \textit{trayectorias}[i][0] \geq  0
            )) \y \\
            ...
            (\forall j : \ent)(0 \leq j < |{\textit{pagos}[i]}\vert \implicaLuego 0 \leq \textit{apuestas}[i][j]))
            \y \\
        ...
        \asegura{
            ...
            (\forall i : \ent)(0 \leq i < |{\textit{trayectorias}[i]}\vert \implicaLuego |{\textit{trayectorias}[i]}\vert = |{\textit{eventos}[i]}\vert +1)
            }
